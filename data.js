window.PORTFOLIO_DATA = {
  ...
  // demo: 배포된 사이트 주소(선택). 넣으면 모달에 '배포 사이트 바로가기' 버튼이 먼저 뜨고,
  //       github 버튼은 보조 스타일로 밀립니다. 없으면 github 버튼만 표시됩니다.
  projects: [
    {
      priority: 0,
      category: "game",
    ...
    },
    {
      ...
      demo: "https://riot-report.onrender.com",
    ...
    },
    {
      ...
      result: "Vercel 배포 및 운영 중",
      demo: "https://skillprac.vercel.app/",
